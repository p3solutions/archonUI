...
describe('WorkspaceListComponent', () => {
  ...
  it('Should display the observable data  for workspaceList component', () => {
    ...
    // console.log(version,'--',workspaceName.textContent,'--',databaseList.textContent.substring(15),'--',lastUpdatedTime.textContent.substring(19),'--',masterMetadataVersion.textContent.substring(18));
    ...
    expect(masterMetadataVersion.textContent.substring(18)).toContain(component.workspaceListInfo[0].masterMetadataVersion);
